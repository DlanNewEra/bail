...
```json
"depencies": {
  "@whiskeysockets/baileys": "github:DlanNewEra/bail"
}
```
## Import
```javascript
...
await client.relayMessage(m.chat, {
  productMessage {
    ...
    url: "https://t.me/dilannalow",
    body: "Nak Tido",
    footer: "Footer",
    buttons: [
      {
        name: "cta_url",
        buttonParamsJson: "{\"display_text\":\"dilan\",\"url\":\"https://t.me/dilannalow\"}"
      }
    ],
